...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $vehicles = [
            // Station Wagon
            ['registration_number' => 'CE-0001-PAK', 'brand' => 'Toyota', 'model' => 'Camry', 'vehicle_type_id' => 1, 'year' => 2022, 'status' => 'active'],

            // Crossover
            ['registration_number' => 'CE-0002-PAK', 'brand' => 'Toyota', 'model' => 'RAV4', 'vehicle_type_id' => 2, 'year' => 2021, 'status' => 'active'],
            ['registration_number' => 'CE-0003-PAK', 'brand' => 'Hyundai', 'model' => 'Creta', 'vehicle_type_id' => 2, 'year' => 2022, 'status' => 'active'],

            // SUV
            ['registration_number' => 'CE-0004-PAK', 'brand' => 'Toyota', 'model' => 'Land Cruiser', 'vehicle_type_id' => 3, 'year' => 2021, 'status' => 'active'],
            ['registration_number' => 'CE-0005-PAK', 'brand' => 'Ford', 'model' => 'Everest', 'vehicle_type_id' => 3, 'year' => 2020, 'status' => 'maintenance'],

            // Tout Terrain
            ['registration_number' => 'CE-0006-PAK', 'brand' => 'Toyota', 'model' => 'Hilux', 'vehicle_type_id' => 5, 'year' => 2021, 'status' => 'active'],
            ['registration_number' => 'CE-0007-PAK', 'brand' => 'Ford', 'model' => 'Ranger', 'vehicle_type_id' => 5, 'year' => 2022, 'status' => 'active'],

            // Coaster
            ['registration_number' => 'CE-0008-PAK', 'brand' => 'Toyota', 'model' => 'Coaster', 'vehicle_type_id' => 6, 'year' => 2020, 'status' => 'active'],
        ];
